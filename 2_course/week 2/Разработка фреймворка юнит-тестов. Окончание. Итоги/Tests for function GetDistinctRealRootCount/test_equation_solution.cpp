...
double GetDescremenant(double a, double b, double c)
{
    return ((b*b) - (4*a*c));
}
...
int GetDistinctRealRootCount(double a, double b, double c) {
    ...
    double D = GetDescremenant(a, b, c);
    if (D > 0)
    {
        return 2;
    }
...
{
    AssertEqual(GetDistinctRealRootCount(0, 2, 1), 1, "2x+1 = 0 has 1 real roots.");
    AssertEqual(GetDistinctRealRootCount(0, -1, 0), 1, "-x = 0 has 0 real roots.");
    AssertEqual(GetDistinctRealRootCount(0, 120, -10), 1, "120x - 10 = 0 has 0 real roots.");
}

void TestConstant()
{
    AssertEqual(GetDistinctRealRootCount(0, 0, 1), 0, "c = 0, where c = 1 has 1 real roots.");
